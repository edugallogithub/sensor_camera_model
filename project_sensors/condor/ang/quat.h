...
public:
    ...
    inline static Eigen::Vector4d convert_3dto4d(const Eigen::Vector3d& v3) {return {0., v3(0), v3(1), v3(2)};}
    /**< create a 3D vector from a 4D vector */
    inline static Eigen::Vector3d convert_4dto3d(const Eigen::Vector4d& v4) {return {v4(1), v4(2), v4(3)};}
    ...
    /**< ===== ===== Linear Algebra ===== ===== */
    /**< get 4x1 vector (do not use operator () as then it is implicit I have to use everywhere) */
    Eigen::Vector4d& get() {return *this;}
    const Eigen::Vector4d& get() const {return *this;}
