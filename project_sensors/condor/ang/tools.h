...
public:
    ...
    /**< ===== ===== ===== ===== ===== ======================== ===== ===== ===== ===== ===== */
    /**< ===== ===== a.quat_cross(b) == a.skew4() * b = b.right_skew4() * a ===== ===== ===== */
    /**< ===== ===== ====================================== === ============================= */
    ...
    /**< ===== ===== ===== ===== ============================== ===== ===== ===== ===== ===== */
    /**< ===== ===== a.quat_cross([0 b]) == a.skew43() * b = b.right_skew43() * a ===== ===== */
    /**< ==================================================================================== */
    ...
    static Eigen::Matrix3d jacobian_triple(const Eigen::Vector3d& a, const Eigen::Vector3d& b);
}; // closes class tools
