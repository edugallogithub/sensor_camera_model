...
env::earth::earth(math::seeder& Oseeder, env::logic::WIND_ID wind_id, env::logic::OFFSETS_ID offsets_id, env::logic::ZONE_ID zone_id,
        env::logic::REALISM_ID realism_id, const double& turb_factor, const double& t_sec_turb_init, const int& t_sec_turb_end)
: _Poffsets(nullptr), _Pwind(nullptr), _Pturb(nullptr), _Pgeo(nullptr) {
    ...
    _Pgeo     = new env::geo_mix(zone_id, realism_id, Oseeder.provide_seed(math::seeder::seeder_geo));
}
/* constructor based on seeder object, identifiers for wind filed, atmospheric offsets, location, magnetic location, gravity and
