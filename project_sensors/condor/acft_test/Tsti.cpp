...
void acft::test::Tsti::run() {
    ...
    env::earth Oearth(Oseeder, env::logic::wind_id01, env::logic::offsets_id01, env::logic::zone_default, env::logic::realism_grav_yes_magn_yes, 0.5, 0., 1000);
...
void acft::test::Tsti::test1(const double& psi_deg, const env::earth& Oearth) {
    ...
    double phi_deg = 40.0;
    double h_m = 3000.0;
    ang::so3_tangent w_nbb_rps(Eigen::Vector3d::Zero());
    double hground_m = 0.;
