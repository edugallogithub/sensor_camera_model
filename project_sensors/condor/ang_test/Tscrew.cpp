...
ang::test::Tscrew::Tscrew(jail::counter& Ocounter)
: ::jail::unit_test(Ocounter) {
}
/* constructor based on counter */

void ang::test::Tscrew::run() {
	::jail::unit_test::run();
...
void ang::test::Tscrew::test() {
    ...
    ang::quat AZ_qd_nb        = OqT_nbn * AZ_qr_nb() * 0.5;
    ...
    Eigen::Vector3d AT_nbn = ang::quat::convert_4dto3d(AZ_qd_nb * AZ_qr_nb().adjoint()) * 2.;
    ...
    Eigen::Vector3d DT_nbn = ang::quat::convert_4dto3d(CZ_qd_nb * CZ_qr_nb().adjoint()) * 2.;
