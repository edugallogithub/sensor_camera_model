...
Eigen::Vector3d acft::aero3::obtain_cf_aer(const double& vtas_mps, const ang::euler& euler_wfsbfs_rad, const Eigen::Array4d& delta_control, const ang::so3_tangent& w_nedbfsbfs_rps) const {
...
Eigen::Vector3d acft::aero3::obtain_cm_aer(const double& vtas_mps, const ang::euler& euler_wfsbfs_rad, const Eigen::Array4d& delta_control, const ang::so3_tangent& w_nedbfsbfs_rps) const {
