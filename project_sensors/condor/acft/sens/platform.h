...
private:
    ...
    /**< true translation from aircraft reference (wing trailing edge) "r" to platform "p" viewed in body "b" */
    Eigen::Array3d _Trpb_m_truth;
    /**< estimated translation from aircraft reference (wing trailing edge) "r" to platform "p" viewed in body "b" */
...
public:
    ...
    /**< get true translation from aircraft reference (wing trailing edge) "r" to platform "p" viewed in body "b" */
    const Eigen::Array3d& get_Trpb_m_truth() const {return _Trpb_m_truth;}
    /**< get estimated translation from aircraft reference (wing trailing edge) "r" to platform "p" viewed in body "b" */
