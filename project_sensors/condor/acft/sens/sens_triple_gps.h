...
private:
    ...
    /**< flag indicating whether position error has been computed at least once (and hence stored for later use) or not */
    bool _flag_used;
    /**< NED position error resulting from first use of this class */
    Eigen::Vector3d _first_pos_error_ned;
...
public:
    ...
    const Eigen::Vector3d& get_first_pos_error_ned() const;
