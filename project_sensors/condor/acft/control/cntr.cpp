...
void control::cntr::initialization(st::st_cntr& Ost_cntr, const st::st_truth& Ost_truth, const st::st_nav_in& Ost_nav_in, const control::guid& Oguid) {
    ...
    //std::cout << "CCCCCC 1   " << std::fixed << std::setw(14) << std::setprecision(5) << std::showpos << _Ppid_ail_prim->get_low_pass_ramp_prim().get_Tf_sec()
    //                           << std::fixed << std::setw(14) << std::setprecision(5) << std::showpos << _Ppid_ail_prim->get_low_pass_ramp_prim().get_Deltat_sec()
    //                           << std::endl; //////////////////
    //std::cout << "CCCCCC 2   " << Oguid.get()[0]->get_guid_ail_id() << std::endl; //////////////////////////

    double ail_Tf = control::pid_factory::obtain_ail_low_pass_ramp_prim_multiple(Oguid.get()[0]->get_guid_ail_id());

    //std::cout << "CCCCCC 3   " << ail_Tf << std::endl; /////////////////
    ...
    //std::cout << "CCCCCC 4   " << std::fixed << std::setw(14) << std::setprecision(5) << std::showpos << _Ppid_ail_prim->get_low_pass_ramp_prim().get_Tf_sec()
    //                           << std::fixed << std::setw(14) << std::setprecision(5) << std::showpos << _Ppid_ail_prim->get_low_pass_ramp_prim().get_Deltat_sec()
    //                           << std::endl; //////////////////
