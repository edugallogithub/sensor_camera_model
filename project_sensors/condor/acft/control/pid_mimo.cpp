...
void control::pid_mimo::fill_target(st::st_cntr& Ost_cntr, const control::guid_op& Oguid_op, control::logic::CNTR_ID cntr_id, const st::st_cntr& Ost_cntr_prev) const {
    ...
    //if (cntr_id == control::logic::cntr_AIL) {
    //    if (Ost_cntr.get_t_sec() > 170) {
    //        if (Ost_cntr.get_t_sec() < 185) {
    //            std::cout << std::fixed << std::setw(14) << std::setprecision(5) << std::showpos << Ost_cntr.get_t_sec()
    //                      << std::fixed << std::setw(14) << std::setprecision(5) << std::showpos << Oguid_op.get_guid_val(cntr_id)
    //                      << std::fixed << std::setw(14) << std::setprecision(5) << std::showpos << Ost_cntr.get_target()[cntr_id]
    //                      << std::fixed << std::setw(14) << std::setprecision(5) << std::showpos << _Plpf_ramp->get_Tf_sec()
    //                      << std::fixed << std::setw(14) << std::setprecision(5) << std::showpos << _Plpf_ramp->get_Deltat_sec()
    //                      << std::fixed << std::setw(14) << std::setprecision(5) << std::showpos << _Plpf_ramp->get_alpha()
    //                      << std::fixed << std::setw(14) << std::setprecision(5) << std::showpos << _Plpf_ramp->get_beta()
    //                      << std::fixed << std::setw(14) << std::setprecision(5) << std::showpos << _Plpf_ramp->get_y_prev()
    //                      << std::endl; //////////////////////////
    //        }
    //    }
    //}
