...
private:
    ...
    ang::so3_tangent _w_enn_rps;
    /**< angular speed from ECEF to IRS in NED */
    ang::so3_tangent _w_ien_rps;
    ...
    /**< atmospheric density */
    double _rho_kgm3;
    /**< height above ground to compute turbulence exclusively */
    double _height_m_for_turbulence;
    ...
    /**< temperature differential at mean sea level */
    double _DeltaT_degK;
    /**< pressure differential at mean sea level */
    double _Deltap_pa;
    /**< pressure altitude */
    double _Hp_m;
    /**< NED low frequency wind */
...
public:
    ...
    ang::so3_tangent& get_w_enn_rps() {return _w_enn_rps;}
    const ang::so3_tangent& get_w_enn_rps() const {return _w_enn_rps;}
    /**< get angular speed from ECEF to IRS in NED */
    ang::so3_tangent& get_w_ien_rps() {return _w_ien_rps;}
    const ang::so3_tangent& get_w_ien_rps() const {return _w_ien_rps;}
    ...
    /**< get height above ground to compute turbulence exclusively */
    double& get_height_m_for_turbulence() {return _height_m_for_turbulence;}
    const double& get_height_m_for_turbulence() const {return _height_m_for_turbulence;}
