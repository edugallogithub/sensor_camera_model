...
public:
    ...
    static guid* create_guid(math::seeder& Oseeder, const unsigned short& case_guid, env::logic::ZONE_ID zone_id, const double& t_sec_gpsloss, bool flag_console = true);
