#ifndef ACFT_ERROR_GEN_ATT
#define ACFT_ERROR_GEN_ATT
...
public:
    ...
    static st::error_gen_att* create_init_eul_error_generator(st::logic::INITEUL_ID, const int& seed);
