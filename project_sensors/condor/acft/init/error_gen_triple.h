#ifndef ACFT_ERROR_GEN_TRIPLE
#define ACFT_ERROR_GEN_TRIPLE
...
class ACFT_API error_gen_triple {
private:
    /**< white noise [unit] */
    double _sigma;
    /**< seed generator */
...
public:
    ...
    static st::error_gen_triple* create_init_acc_error_generator(st::logic::INITACC_ID, const int& seed);
    /**< create initial gyroscope error generator */
    static st::error_gen_triple* create_init_gyr_error_generator(st::logic::INITGYR_ID, const int& seed);
    /**< create initial magnetometer error generator */
    static st::error_gen_triple* create_init_mag_error_generator(st::logic::INITMAG_ID, const int& seed);
    /**< create initial NED magnetic field error generator */
    static st::error_gen_triple* create_init_mgn_error_generator(st::logic::INITMGN_ID, const int& seed);
